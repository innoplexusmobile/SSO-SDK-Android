...
public class SocialPlugin {
    ...
    public void callSocialLoginApi(final Context context, String accessToken, String loginType, JSONObject responseJson, final LoginCallback loginCallback) {
                        ...
                        if (loginResponse != null) {
                            ...
                            if (data.otpEnabled) {
                                ...
                                if (data.info != null) {
                                    ...
                                    RetrofitRequestBuilder.getInstance(context).socialLoginAuthorize(context, new Callback<LoginParentPojo>() {
                                        @Override
                                        public void onResponse(Call<LoginParentPojo> call, Response<LoginParentPojo> response) {
